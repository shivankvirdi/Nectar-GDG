...
<table width="100%">
  <tr>
    ...
    <td width="50%" align="center" style="vertical-align: top;">
      <details>
        <summary style="cursor: pointer; list-style: none; outline: none; font-weight: bold; color: #0969da;">
          🔍 Click here to enlarge Price History chart
        </summary>
        <div style="margin-top: 10px;">
          <img src="https://github.com/user-attachments/assets/df83ff3c-324b-439e-b0ee-169f1a7cd1f1" width="100%" alt="nectar price history">
        </div>
      </details>
      <br>
      <!-- Small preview thumbnail underneath the toggle link -->
      <img src="https://github.com/user-attachments/assets/df83ff3c-324b-439e-b0ee-169f1a7cd1f1" width="100%" alt="nectar price history preview">
    </td>
  </tr>
</table>
